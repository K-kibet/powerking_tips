...
import { NetworkWifi1Bar, SearchOutlined } from '@mui/icons-material';
  ...
  return (
    <div className="tips">
      ...
      <div className="wrapper">
          {
            tips.length && tips.filter((tip) => (category==='free') ? (tip.premium === true) : (tip.premium === false)).map(tip => {
